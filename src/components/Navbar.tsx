      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            <button onClick={openWishlist} className="relative p-2 text-bark-400 hover:text-forest-500 transition-colors">
            ...
            <button onClick={openCart} className="relative p-2 text-bark-400 hover:text-forest-500 transition-colors">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
